...
The bundled current-format example is `inst/dynports/SDL2.dynport`:
...
The source tree also contains older `inst/dynports/*.R` binding resources from
previous rdyncall releases. They are kept as legacy material and examples of the
older binding style, not as the current DCF DynPort format.
