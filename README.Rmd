...
- Build larger bindings with [dynbind and DynPort bindings](https://hongyuanjia.github.io/rdyncall/articles/dynbind-dynport.html),
  [Porter and SDL3 DynPort](https://hongyuanjia.github.io/rdyncall/articles/porter-sdl3.html),
...
articles for how to regenerate the metadata, load it with `dynport()`, and run
a non-GUI SDL3 smoke test.
