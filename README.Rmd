...
The package ships one current-format DynPort, `inst/dynports/SDL3.dynport`,
...
For other C libraries, generate a DCF `.dynport` file with porter or another
header-processing workflow and pass it to `dynport(portfile = ...)`.
